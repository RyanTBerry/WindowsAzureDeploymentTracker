...
namespace DeploymentTracker.App.Dialogs
{
    ...
    public partial class PasswordPrompt : Form
    {
        ...
        public PasswordPrompt(string certificateName)
        {
            this.InitializeComponent();
            this.lblPrompt.Text = string.Format(this.lblPrompt.Text, certificateName);
        }

        /// <summary>
        /// Gets or sets the given password.
        /// </summary>
        /// <value>
        /// The given password.
        /// </value>
        ...
        {
            this.GivenPassword = mtxPassword.Text;
        ...
        {
            if (DialogResult.Yes == MessageBox.Show("Are you sure you want to cancel this?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
            {
