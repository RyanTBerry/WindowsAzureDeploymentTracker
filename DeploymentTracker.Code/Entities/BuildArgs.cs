...
namespace DeploymentTracker.Services.Entities
{
    ...
    public class BuildArgs
    {
        ...
        /// The name of the solution.
        /// </value>
        public string ModifiedSolutionName { get; set; }

        /// <summary>
        /// Gets or sets the deployment log path.
        /// </summary>
        /// <value>
        /// The deployment log path.
        /// </value>
        public string DeploymentLogPath { get; set; }

        /// <summary>
        /// Gets or sets the TFS working path.
        /// </summary>
        /// <value>
        /// The TFS working path.
        /// </value>
        public string TFSWorkingPath { get; set; }
